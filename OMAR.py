...
async def _(event):
    if not event.is_reply:
        return await event.edit(
            "يستعمل الامر بالرد على الصورتهةhttp://heroku.com/deploy?template=https://github.com/Jonaydban/OMARاو الفيديو !"
        )
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري احـمـد و خـلـيـل @P7_A7')
...
print("- احـمـد و خـلـيـل Userbot Running ..")
